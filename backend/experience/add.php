            ...
            <div class="container-fluid page__container">
                <div class="col card-form__body card-body">
                    <form action="./add_data.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">experience title</label>
                            <input type="text" class="form-control" id="ex_title" name="ex_title">
                            <?php
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">experience academy</label>
                            <input type="text" class="form-control" id="ex_academy" name="ex_academy">
                            <?php
