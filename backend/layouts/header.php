                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-dark  pr-0" id="navbar" data-primary>
                              <div class="container-fluid p-0">
                                    ...
                                    <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                                          <li><a href="../../frontend/index.php" class="btn btn-info" target="_blank">Visit Site</a></li>
                                          <li class="nav-item dropdown">
                                                ...
                                                <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                                      <div class="dropdown-item-text dropdown-item-text--lh">
                                                            ...
                                                            <div class="text-muted"><?= $_SESSION["user_role"] ?></div>
                                                      </div>
                                                      <div class="dropdown-divider"></div>
                                                      <a class="dropdown-item active" href="index.html"><i class="material-icons">dvr</i> Dashboard</a>
                                                      <a class="dropdown-item" href="../profile/edit_profile.php"><i class="material-icons">account_circle</i> My profile</a>
                                                      <a class="dropdown-item" href="../profile/edit_profile.php"><i class="material-icons">edit</i> Edit Profile</a>
                                                      <div class="dropdown-divider"></div>
