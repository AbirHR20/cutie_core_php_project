            ...
            <div class="container-fluid page__container">
                <div class="col card-form__body card-body">
                    <form action="./add_data.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">awards title</label>
                            <input type="text" class="form-control" id="aw_title" name="aw_title">
                            <?php
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">awards academy</label>
                            <input type="text" class="form-control" id="aw_academy" name="aw_academy">
                            <?php
