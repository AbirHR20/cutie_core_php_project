        ...
        <div class="mdk-drawer-layout__content page">
            ...
            <div class="container-fluid page__container">
                <div class="col card-form__body card-body">
                    <form action="../services/add-data.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_description" rows="5" cols="30" class="form-control"></textarea>
                            <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control service_icon" id="" name="icon" readonly>
                            <?php
