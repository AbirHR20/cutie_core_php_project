                ...
                <div class="col card-form__body card-body">
                    <form action="./add_data.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            if (isset($_SESSION["t_name_error"])) : ?>
                                <small class="text-danger"><?= $_SESSION["t_name_error"] ?></small>

                            <?php
                            endif;
                            unset($_SESSION["t_name_error"]);
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            if (isset($_SESSION["t_role_error"])) : ?>
                                <small class="text-danger"><?= $_SESSION["t_role_error"] ?></small>

                            <?php
                            endif;
                            unset($_SESSION["t_role_error"]);
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            if (isset($_SESSION["t_description_error"])) : ?>
                                <small class="text-danger"><?= $_SESSION["t_description_error"] ?></small>

                            <?php
                            endif;
                            unset($_SESSION["t_description_error"]);
                            ?>
                        </div>
